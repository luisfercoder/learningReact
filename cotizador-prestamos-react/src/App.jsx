...
function App() {
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <h2 className='text-2xl font-extrbold text-gray-500 text-center'>
      ...
      <div className='my-5 space-y-3 bg-gray-50 p-5'>
        ...
        <p className='text-xl text-gray-500 text-center font-bold'>{formatearDInero(total)}Totales a pagar</p>
